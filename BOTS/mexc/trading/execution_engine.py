...
class ExecutionEngine:
    ...
    def _execute(self, pair: str, side: OrderSide, entry_price: float,
        ...
        log.info("ExecutionEngine: executed %s %.4f @ %.2f", pair_side, quantity, fill_price)
    ...
    def close_position_market(self, position_id: str) -> ExecutionResult:
        ...
        if closed:
            ...
            log.info("ExecutionEngine: closed %s at %.2f", pos.pair, exit_price)
